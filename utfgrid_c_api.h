...
GOAPICALL utfgrid_t *utfgrid_new();
...
GOAPICALL wchar_t utfgrid_draw_line(utfgrid_t *m, double x1, double y1, double x2,
                           double y2, double width);
GOAPICALL wchar_t utfgrid_draw_polygon(utfgrid_t *m, double *points, int count);
GOAPICALL wchar_t utfgrid_draw_ellipse(utfgrid_t *m, double x, double y, double rx,
                              double ry);
